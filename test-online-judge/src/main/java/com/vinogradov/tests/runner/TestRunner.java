package com.vinogradov.tests.runner;

import com.vinogradov.contracts.submissionResult.model.JudgeResult;
import com.vinogradov.tests.fixture.TestData;
import com.vinogradov.tests.fixture.TestDataGenerator;
import com.vinogradov.tests.service.TestSubmissionService;
import com.vinogradov.tests.validator.ResultValidator;
    ...
    public void runTests() {
        ...
        for (TestData testData : testCases) {
            try {
                ...
                com.vinogradov.tests.validator.ValidationResult validation = validator.validate(result, testData);
